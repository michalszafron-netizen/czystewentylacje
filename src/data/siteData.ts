    ...
    testimonials: [
      {
        ...
        role: "Nauczycielka",
        text: "Byłam bardzo zadowolona z jakości usług i profesjonalnego podejścia. Polecam wszystkim."
      },
      {
        name: "Adam Szczepański",
        role: "Grafik komputerowy",
        text: "Bardzo punktualni i dokładni. Obsługa przyjazna i pomocna. Skorzystam ponownie."
      },
      {
        name: "Marta Jankowska",
        role: "Przedstawicielka handlowa",
        text: "Szybko, skutecznie i dostępnie cenowo. Gorąco polecam!"
      }
    ]
  },
  uslugi: {
